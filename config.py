...
MAX_DAYS_NO_TRADE = 15  # 連續未交易N天後考慮強制進場
...
FORCED_TRADE_CAPITAL_ALLOCATION = 0.2  # 強制進場時使用的資金比例 

# === 新增：一般策略交易資金分配 ===
REGULAR_TRADE_CAPITAL_ALLOCATION = 0.4 # 一般策略進場時使用的資金比例 (例如 20% 的現金)
...
# --- 策略目標持續性設定 ---
MIN_STRATEGY_DURATION_DAYS = 30 # LLM選擇的策略目標建議至少執行的天數

# === 交易單位與精度設定 ===
TRADE_UNIT = 1 # 交易單位，設為 1 可交易零股，設為 1000 代表一張股票
